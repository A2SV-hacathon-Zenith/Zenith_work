  ...
  return(
    <Layout>
          ...
          <Footer>
            ...
            <footer class="bg-white dark:bg-emerald-800 rounded-xl">
                <div class="mx-auto w-full max-w-screen-xl">
                  <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
                    <div>
                        <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Company</h2>
                        <ul class="text-white list-none font-medium">
                            <li class="mb-4">
                ...
                <div class="px-4 py-6 bg-gray-100 dark:bg-emerald-900 md:flex md:items-center md:justify-between">
                    <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="">Zenith</a>. All Rights Reserved.
                    </span>
